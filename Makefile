...
# graphics.c, mouse.c, wm.c 추가
C_SOURCES = src/kernel.c src/graphics.c src/mouse.c src/wm.c src/idt.c src/keyboard.c src/string.c src/pmm.c src/vmm.c src/heap.c src/task.c src/timer.c src/vfs.c src/cloudfs.c src/ahci.c src/elf.c src/e1000.c src/net.c
