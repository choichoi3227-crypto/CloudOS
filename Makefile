...
C_SOURCES = src/kernel.c src/vga.c src/idt.c src/keyboard.c src/string.c src/pmm.c src/vmm.c src/heap.c src/task.c src/timer.c src/vfs.c src/cloudfs.c src/ahci.c src/elf.c
